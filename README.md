...
* **Github:** [로봇팔 제어 Repository](https://github.com/exponent1121/robotarm-control)
...
* **Notion:** [EnsembleSync 팀 협업 노션](https://www.notion.so/EnsembleSync-44d7bcc855ea8360a7d881ea69f7ad34)
...
* **상세 역할:**
  ...
  * **[Raspberry Pi]**
    ...
    - **Github:** [라즈베리파이 실습 코드 Repository](https://github.com/exponent1121/raspberrypi-practice)
...
* **Github:** [라인트레이서 제어 코드 Repository](https://github.com/exponent1121/arduino-line-tracer)
* **시연 영상:** [주행 테스트 영상]
