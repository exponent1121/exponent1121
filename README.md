...
* **소속:** 창업 동아리 미래제품연구회
* **기간:** 2026.04 ~ 2026.05
* **기술 스택:** `ESP32`, `MicroPython (Thonny)`, `Fusion 360`
* **요약:** 하드웨어 조립부터 모션 제어 코드 구현까지 아우르는 로봇팔 구동 프로젝트.
* **상세 역할:**
  * 로봇팔 하드웨어 키트 조립 및 ESP32 마이크로컨트롤러 환경 구성.
  * Thonny IDE를 활용하여 서보모터 구동 및 각도 제어를 위한 소프트웨어 로직 구현.
  * Fusion 360을 이용한 기초 3D CAD 모델링 실습을 통해 하드웨어 설계 데이터(Real-world)에 대한 이해도 향상.
...
* **상세 역할:**
  ...
  * **[Raspberry Pi]** Linux(Raspbian OS) 환경에서 Python 기반으로 온습도 센서, OLED 디스플레이, 카메라 스트리밍 제어 등 하드웨어와 소프트웨어를 통합하는 시스템 제어 실습 이수.
...
* **Github:** [라인트레이서 제어 코드]()
* **시연 영상:** [주행 테스트 영상]
  ![라인트레이서 작동 영상](https://github.com/user-attachments/assets/b734ce35-29a2-4d26-966e-bbf26f433988)
